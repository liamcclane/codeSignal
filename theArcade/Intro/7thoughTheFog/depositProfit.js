 ...
 * @returns {number} return how many years assuming that you don't additionally deposit you will 
 * reach your thresh hold
 */
function depositProfit(deposit, rate, threshold) {

    let count  = 0, runningTot = deposit;
    
    do {
        count++;
        runningTot += (runningTot*(rate*0.01));
        
    } while (runningTot < threshold);
